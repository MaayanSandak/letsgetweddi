...
import com.example.letsgetweddi.databinding.FragmentHairBinding
...
class HairFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.recyclerHair.layoutManager = LinearLayoutManager(requireContext())
        ...
        database.orderByChild("category").equalTo("hair")
